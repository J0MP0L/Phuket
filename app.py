...
def render_content(tab):
    if tab== "tab-1":
        return html.Div([
            ...
            dcc.Markdown("""
- **ด้านเรื่องของทางภูมิอากาศ** \n        เนื่องด้วยทางด้านจังหวัดในทางด้านสภาพอากาศในการปลูกข้าวเราจะสามารถเห็นได้ ว่าทางภูเก็ตนั้นได้ รับเรื่องของทางด้านอิทธิพลทางด้านเรื่องของ มรสุม ทั้ง 2 อย่างคือมรสุมทางด้านตะวันออกเฉียงเหนือ เเละทางด้านตะวันตกเฉียงใต้โดยทางด้าน ตกเฉียงใต้จะทำให้ฝนตกนั้นเกิดตลอดทั้งปี ส่วน ในทางด้านตะวันออกเฉียงเหนือนั้นจะเป็นทางด้านคความเเห้งเเล้งมากกว่า โดยเราจะสามารถมองรวมได้ว่าทางตะวันตกเฉัยง ใต้ได้รับอิธิพลมากที่สุดจากการที่ผนตก นอกจากนี้ ทำให้ทางภูเก็ตนั้นสามารถปลูกทางด้านข้าวได้มีประสิทธิภาพเนื่องจากการเกิด ความชุ่มชื้นในตัวดินตลอดทั้งปีจากมรสุมตะวันตกเฉัยงใต้ 
...
""")
        ...
        # หน้าแรก - แสดงกราฟ EOS_map ใหญ่ๆ
        return html.Div([
            html.H3("แผนที่ EOS"),
        ...
        # หน้า 2 - แสดงกราฟ fig2 และ fig3 พร้อมคำอธิบายทางขวา
        return dbc.Row([
            dbc.Col([
